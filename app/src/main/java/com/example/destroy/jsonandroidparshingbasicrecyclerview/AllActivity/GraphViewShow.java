...
public class GraphViewShow extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (cityin.toLowerCase().equals("dhaka")){
        ...
        if (cityin.toLowerCase().equals("rajshahi")){
            weatherApig=RetrofitClient.getRetrofitClient().create(WeatherApi.class);
            Call<PredictionList> predictionListCall=weatherApig.getPredictionListraj();
            Call<SevendaysHistory>sevendaysHistoryCall=weatherApig.getSevendaysHistoryraj();
            predictionListCall.enqueue(new Callback<PredictionList>() {
                @Override
                public void onResponse(Call<PredictionList> call, Response<PredictionList> response) {
                    PredictionList predictionList=response.body();
        ...
        if (cityin.toLowerCase().equals("rangpur")){
            weatherApig=RetrofitClient.getRetrofitClient().create(WeatherApi.class);
            Call<PredictionList> predictionListCall=weatherApig.getPredictionListrang();
            Call<SevendaysHistory>sevendaysHistoryCall=weatherApig.getSevendaysHistoryraj();
            predictionListCall.enqueue(new Callback<PredictionList>() {
                @Override
                public void onResponse(Call<PredictionList> call, Response<PredictionList> response) {
        ...
        if (cityin.toLowerCase().equals("sylhet")){
            weatherApig=RetrofitClient.getRetrofitClient().create(WeatherApi.class);
            Call<PredictionList> predictionListCall=weatherApig.getPredictionListsyl();
            Call<SevendaysHistory>sevendaysHistoryCall=weatherApig.getSevendaysHistorysyl();
            predictionListCall.enqueue(new Callback<PredictionList>() {
                @Override
                public void onResponse(Call<PredictionList> call, Response<PredictionList> response) {
                    PredictionList predictionList=response.body();
        ...
        if (cityin.toLowerCase().equals("khulna")){
            weatherApig=RetrofitClient.getRetrofitClient().create(WeatherApi.class);
            Call<PredictionList> predictionListCall=weatherApig.getPredictionListkhul();
            Call<SevendaysHistory>sevendaysHistoryCall=weatherApig.getSevendaysHistorykhul();
            predictionListCall.enqueue(new Callback<PredictionList>() {
                @Override
                public void onResponse(Call<PredictionList> call, Response<PredictionList> response) {
                    PredictionList predictionList=response.body();
        ...
        if (cityin.toLowerCase().equals("chittagong")){
            weatherApig=RetrofitClient.getRetrofitClient().create(WeatherApi.class);
            Call<PredictionList> predictionListCall=weatherApig.getPredictionListchit();
            Call<SevendaysHistory>sevendaysHistoryCall=weatherApig.getSevendaysHistorychit();
            predictionListCall.enqueue(new Callback<PredictionList>() {
                @Override
                public void onResponse(Call<PredictionList> call, Response<PredictionList> response) {
                    PredictionList predictionList=response.body();
        ...
        if (cityin.toLowerCase().equals("barisal")){
            weatherApig=RetrofitClient.getRetrofitClient().create(WeatherApi.class);
            Call<PredictionList> predictionListCall=weatherApig.getPredictionListbar();
            Call<SevendaysHistory>sevendaysHistoryCall=weatherApig.getSevendaysHistorcom();
            predictionListCall.enqueue(new Callback<PredictionList>() {
                @Override
                public void onResponse(Call<PredictionList> call, Response<PredictionList> response) {
                    PredictionList predictionList=response.body();
        ...
        if (cityin.toLowerCase().equals("comilla")){
            weatherApig=RetrofitClient.getRetrofitClient().create(WeatherApi.class);
            Call<PredictionList> predictionListCall=weatherApig.getPredictionListcom();
            Call<SevendaysHistory>sevendaysHistoryCall=weatherApig.getSevendaysHistorcom();
            predictionListCall.enqueue(new Callback<PredictionList>() {
                @Override
                public void onResponse(Call<PredictionList> call, Response<PredictionList> response) {
